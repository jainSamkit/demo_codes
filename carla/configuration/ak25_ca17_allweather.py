#this file trains for data from virtual world elektra data by agent;steer only, implementing ak17_cf45_steer.py
#also does augmentation for seven cameras
#it has data for all weather one forward and backward laps each
import random
...
class configInput(configMain):
	...
	def __init__(self):
		...
		path = '../VirtualElektraData2_AllWeather'
