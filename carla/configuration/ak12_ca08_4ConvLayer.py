#this file trains for data from real world elektra data(steer only), implementing ak08_ca04_steer.py
#it has lower learning rate
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.learning_rate = 0.00002 # First
