#this file trains for data from virtual world elektra data by human;steer only, implementing ak21_ca18_more2dropout
#implements only general aug, no label wise
#training data increased in this exp
import random
...
class configMain:
	...
	def __init__(self):
		...
		self.dropout = [0.8]*3 + [0.7]*2 + [0.55]*3 + [0.5]*2  + [0.5,0.5]*len(self.branch_config)
