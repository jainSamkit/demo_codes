#class Control:
#  steer = 0 # Steer goes from -1 to 1
#  gas =0 # Gas should go from -1 to 1
...
class Measurements:
  ...
  gps_x = 0
  gps_y = 0.0
  # And all the other posible data that can be set
...
class Driver(object):
  ...
  def _adjust_steering(self,steering,angle,speed):
	...
	print math.atan((angle*self._car_lenght)/(self._time*speed+0.01))/3.1415
