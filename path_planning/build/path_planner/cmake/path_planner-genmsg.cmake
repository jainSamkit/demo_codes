...
get_filename_component(_filename "/home/darth/Desktop/sc2_ros/src/path_planner/srv/FindPath.srv" NAME_WE)
add_custom_target(_path_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "path_planner" "/home/darth/Desktop/sc2_ros/src/path_planner/srv/FindPath.srv" ""
)

get_filename_component(_filename "/home/darth/Desktop/sc2_ros/src/path_planner/srv/CreateGraph.srv" NAME_WE)
add_custom_target(_path_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "path_planner" "/home/darth/Desktop/sc2_ros/src/path_planner/srv/CreateGraph.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_planner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_planner\")")
  # install generated code
  install(
