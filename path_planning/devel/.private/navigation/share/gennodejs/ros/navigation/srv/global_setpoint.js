...
class global_setpointRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type global_setpointRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type global_setpointRequest
    let len;
    let data = new global_setpointRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new global_setpointRequest(null);
...
class global_setpointResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type global_setpointResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type global_setpointResponse
    let len;
    let data = new global_setpointResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'navigation/global_setpointResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new global_setpointResponse(null);
...
module.exports = {
  Request: global_setpointRequest,
  Response: global_setpointResponse,
  md5sum() { return '84e486425bbf35fea76b0e2acc4e452e'; },
  datatype() { return 'navigation/global_setpoint'; }
};
